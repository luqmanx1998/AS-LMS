...
function UserList() {
  ...
  const [activeModal, setActiveModal] = useState(null); // { type: "deactivate", employee }
  ...
  return (
    <>
      ...
      {createAccModalIsOpen && (
        <CreateAccModal setCreateAccModalIsOpen={setCreateAccModalIsOpen} />
      )}
      ...
      <div>
        <div className="rounded-2xl border-[#DFE4EA] border-[1px] px-4 py-4">
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            >
              <option value="drivers" className="text-[#4A4A4A]">
                Drivers
              </option>
            </select>
          </div>
          ...
          <div className="border-[#DFE4EA] border-[1px] rounded-lg">
            ...
            <div className="px-4 py-2 overflow-scroll">
              {employees?.map((employee) => (
                <div
                  key={employee.email}
                  className="grid grid-cols-4 w-[552px] justify-items-center items-center not-last:mb-4 relative"
                >
                      ...
                      <ul className="list-none space-y-4">
                        <li className="flex body-2 items-center gap-1.5 text-[#7F8184] cursor-pointer">
                          <svg
                            ...
                            strokeLinecap="round"
                            strokeLinejoin="round"
                            className="lucide lucide-clipboard-list-icon"
                          >
                        ...
                        onClick={() => {
                          ...
                          <svg
                            ...
                            strokeLinecap="round"
                            strokeLinejoin="round"
                            className="lucide lucide-rotate-ccw-key-icon"
                          >
                        ...
                        >
                          <svg
                            ...
                            strokeLinecap="round"
                            strokeLinejoin="round"
                            className="lucide lucide-octagon-x-icon"
                          >
                            <path d="m15 9-6 6" />
